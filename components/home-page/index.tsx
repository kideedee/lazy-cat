        ...
        <div className="space-y-4 md:space-y-6 md:pr-8 xl:col-span-2">
          ...
          <div className="text-base leading-7 text-gray-600 md:text-lg md:leading-8 dark:text-gray-400">
            ...
            <div className="mt-4 mb-6 md:mb-8">
              <p>
                I started learning to code in 2017 during university and have
                been hooked ever since.
              </p>
              <p>
                I graduated in early 2022 and landed my first job as a Backend
                Developer.
              </p>
              <p>
                Currently pursuing my Master's in Computer Science while
                building cool stuff.
              </p>
              <p>
